...
export default function AiAssistant() {
  ...
  return (
    <div className="relative mx-auto max-w-[1500px] p-4 sm:p-6 lg:p-10">
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[340px_minmax(0,1fr)]">
        <aside className="space-y-6">
          ...
          <section className="card-premium p-5">
            <h2 className="font-bold text-slate-800">Current scope</h2>
            ...
            <div className="mt-4 rounded-2xl bg-indigo-50 p-4">
              ...
              <p className="mt-2 break-words text-sm font-semibold text-indigo-950">
              ...
              <p className="mt-1 text-xs leading-5 text-indigo-600">
                {selectedDocumentDetails
                  ? "Only this document will be used to retrieve an answer."
                  : "All ready documents in your organization may be searched."}
              </p>
            </div>
          </section>
        </aside>
            ...
            <>
              {submittedQuestion && (
                <div className="flex justify-end">
                  <div className="max-w-2xl rounded-2xl rounded-tr-md bg-indigo-600 px-4 py-3 text-sm leading-6 text-white shadow-lg shadow-indigo-950/10">
                    {submittedQuestion}
                  </div>
                </div>
              )}
